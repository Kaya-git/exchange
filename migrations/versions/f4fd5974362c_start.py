...
Revision ID: f4fd5974362c
Revises: 
Create Date: 2023-09-15 11:32:38.598835
...
def upgrade() -> None:
    ...
    sa.Column('tikker_id', sa.Integer(), nullable=False),
    ...
    sa.Column('completed_order_id', sa.BigInteger(), nullable=True),
    sa.ForeignKeyConstraint(['completed_order_id'], ['completed_order.id'], ),
